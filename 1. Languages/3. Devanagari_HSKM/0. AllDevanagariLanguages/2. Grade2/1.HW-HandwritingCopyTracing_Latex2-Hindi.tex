...
% --- LANGUAGE-SPECIFIC OFFSETS (All values are RELATIVE to the TEXT BASELINE (0)) ---30
\def\EnglishRedLineGap{-2}      
\def\EnglishGreenLineGap{-10}    
\def\EnglishBlueShift{30}        % Adjustable Blue Line position (Relative to Y=0)
\def\EnglishBlackLineGap{-36}   
\def\EnglishTextShift{4.5}      % Text correction to align its natural baseline with 0

\def\HindiRedLineGap{2.5}        
\def\HindiGreenLineGap{-10}       
\def\HindiBlueShift{-35}          % 4 ADJUSTABLE: Shift Blue Line UP by 5pt
\def\HindiBlackLineGap{-46}     
\def\HindiTextShift{4.5}        

\def\TeluguRedLineGap{0}      
\def\TeluguGreenLineGap{-15}    
\def\TeluguBlueShift{-33}
\def\TeluguBlackLineGap{-20}         
...
\begin{document}
	...
	% --- EXECUTE SETUP COMMANDS (Must be inside \begin{document}) ---
		...
		%\GeneratePracticePage[-17pt]{కృష్ణ కాకి ప్రసాద్}{telugu}
		
		%\GeneratePracticePage{अ  \quad  }{hindi}
		%\GeneratePracticePage{}{telugu}
%		\GeneratePracticePage[-4pt]{అ ా ఇ  ి}{telugu}
%		\GeneratePracticePage[-4pt]{0 ౦ \quad  1  ౧ ౨ ౩ ౪ ౫ ౬ ౭ ౮ ౯ }{telugu}	
			% Page 1 (Original Page 3 Content)
%		\GeneratePracticePage{Aa \quad Bb \quad    Cc \quad    Dd \quad    Ee\quad Ff}{english}
		
		%\SetLanguageParams{తెలుగు }
		%\newpage
		
		\GeneratePracticePage[-5pt]{अ \quad आ  \quad इ  \quad ई  \quad उ  \quad ऊ   }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[-5pt]{  ऋ \quad ए\quad ऐ \quad ओ   \quad औ    }{hindi}\newpage
		\newpage
		
		
		
		\GeneratePracticePage[-3pt]{  अं   \quad अः }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{क \quad  \quad ख    \quad ग    \quad घ  \quad ङ }{hindi}\newpage
		\newpage
		
		
		\GeneratePracticePage[7pt]{च \quad छ \quad ज  \quad झ \quad ञ  }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{ट\quad ठ \quad ड  \quad ढ   \quad ण }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{त   \quad थ    \quad द    \quad ध    \quad न }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{प  \quad फ    \quad ब     \quad भ    \quad म  }{hindi}\newpage
		\newpage
		
		
		\GeneratePracticePage[7pt]{य   \quad र    \quad ल      \quad व     \quad श \quad ष }{hindi}
		\newpage
		
		\GeneratePracticePage[7pt]{स \quad ह\quad   क्ष  \quad त्र  \quad ज्ञ }{hindi}\newpage
		\newpage
		
		
		\GeneratePracticePage[-5pt]{क  \quad का  \quad कि   \quad की   \quad कु   }{hindi}\newpage
		\newpage

		\GeneratePracticePage[-5pt]{ कू \quad     कृ  \quad के \quad कै  \quad को   }{hindi}\newpage
		\newpage
		
		
		
		\GeneratePracticePage[-3pt]{   कौ    \quad कंं   \quad कः  }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{क्क  \quad  \quad  ख्क     \quad ग्क     \quad  घ्क  \quad ङ्क }{hindi}\newpage
		\newpage
		
		
		\GeneratePracticePage[7pt]{ च्क  \quad छ्क  \quad  ज्क  \quad   झ्क \quad ञ्क    }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{ ट्क  ट्ट \quad ठ्क  ट्ठ  \quad  ड्क   \quad ढ़्क   \quad ण्क  }{hindi}\newpage
		\newpage
		
		\GeneratePracticePage[7pt]{ त्क  \quad  थ्क   \quad द्क    \quad ध्क ध्य    \quad न्क  }{hindi}\newpage
		\newpage
		...
		% Add hindi text - words sentences
\end{document}