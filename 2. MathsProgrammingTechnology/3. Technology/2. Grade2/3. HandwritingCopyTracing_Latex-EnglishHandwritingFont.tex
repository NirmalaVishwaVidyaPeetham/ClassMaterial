...
\def\EnglishBlueShift{-27}        % Adjustable Blue Line position (Relative to Y=0)
...
\begin{document}
	...
	% --- EXECUTE SETUP COMMANDS (Must be inside \begin{document}) ---
		...
		\GeneratePracticePage{Gg \quad Hh \quad    Ii \quad  Jj \quad Kk \quad Ll }{english}
		...
		\GeneratePracticePage[1pt]{Mm \quad Nn \quad Oo \quad Pp \quad Qq \quad Rr }{english}
		
		% Page 4 (Original Page 6 Content)
		\GeneratePracticePage[1pt]{Ss \quad Tt \quad Uu \quad Vv \quad Ww \quad Xx}{english}
		
		% Page 5 (Original Page 7 Content)
		\GeneratePracticePage[1pt]{ Yy \quad Zz }{english}
		
		% Page 6 (Original Page 8 Content)
		\GeneratePracticePage[1pt]{0\quad1\quad2\quad3\quad4\quad5\quad6\quad7\quad8\quad9}{english}
		...
		\GeneratePracticePage{power sleeping inside you, like }{english}
		
		% Page 9 (Original Story Page 3)
		\GeneratePracticePage{a tiny dragon. Sahaja Yoga is }{english}
		
		% Page 10 (Original Story Page 4)
		\GeneratePracticePage{a way to wake up that power}{english}
		...
		\GeneratePracticePage{feel good, happy, and peaceful.}{english}
		
		% Page 14 (Original Story Page 8)
		\GeneratePracticePage[-1pt]{ It's like magic, but it's real! }{english}
		
		% Page 15 (Original Story Page 9)
		\GeneratePracticePage{This power can even help you }{english}
		
		% Page 16 (Original Story Page 10)
		\GeneratePracticePage[-1pt]{if you're feeling sick or sad. }{english}
		
		% Page 17 (Original Story Page 11)
		\GeneratePracticePage[-1pt]{It's like a superhero inside you!}{english}
		
		% Page 18 (Original Story Page 12)
		\GeneratePracticePage{Sahaja Yoga is easy and }{english}
		
		% Page 19 (Original Story Page 13)
		\GeneratePracticePage[-1pt]{anyone can do it. You don't}{english}
		
		% Page 20 (Original Story Page 14)
		\GeneratePracticePage{need to be special or know a }{english}
		
		% Page 21 (Original Story Page 15)
		\GeneratePracticePage{lot of things. Just try it and }{english}
		
		% Page 22 (Original Story Page 16)
		\GeneratePracticePage{see how amazing it feels to be }{english}
		
		\GeneratePracticePage{directly connected to God! }{english}
