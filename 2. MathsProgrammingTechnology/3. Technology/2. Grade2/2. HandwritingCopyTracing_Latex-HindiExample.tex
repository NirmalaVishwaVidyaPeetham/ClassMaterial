...
\def\HindiRedLineGap{-9}        
\def\HindiGreenLineGap{-25}       
\def\HindiBlueShift{-36}          % ADJUSTABLE: Shift Blue Line UP by 5pt
\def\HindiBlackLineGap{-62}     
\def\HindiTextShift{4.5}        

\def\TeluguRedLineGap{9}      
\def\TeluguGreenLineGap{-4}    
\def\TeluguBlueShift{-30}
\def\TeluguBlackLineGap{-48}         
...
\newcommand{\PrintText}[3]{%
	\raisebox{-\dim@CurrentTextShift}{% 
		\fontsize{60pt}{120pt}\selectfont \selectlanguage{#1}%
...
\begin{document}
	...
	\GeneratePracticePage[41pt]{अ आ इ ई उ ऊ}{hindi}
	\GeneratePracticePage[39pt]{ए ऐ ओ औ अं अः }{hindi}
	\GeneratePracticePage[44pt]{निर्मलविश्वविद्यापीठम्}{hindi}
