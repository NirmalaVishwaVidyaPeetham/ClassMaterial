...
1. Tech \- md vs html vs latex \- github pages \- fix our website;  
   1. English \- create a copy writing practice book and then complete it; another with cursive font; Add cover pages, page background images etc. to make it a complete book  
      ...
      2. [https://fonts.google.com/?categoryFilters=Calligraphy:%2FScript%2FHandwritten](https://fonts.google.com/?categoryFilters=Calligraphy:%2FScript%2FHandwritten) \- Download and install any font locally and then use in latex \- ABeeZee, Handlee, Playpen\_Sans, Playwrite\_CA\_Guides (with rules automatically included), caveat  
         1. Use cursive: [https://fonts.google.com/?categoryFilters=Calligraphy:%2FScript%2FHandwritten](https://fonts.google.com/?categoryFilters=Calligraphy:%2FScript%2FHandwritten)  \- Beth Ellen ? Ms Madi? Lavishly Yours?  
         2. Hindi \- Kalam?   
...
2. HW: Create a table of contents for everything we learnt in Grade 1 \- Telugu, like in a textbook. \- Fix and Move into the right folder \- Convert to md files as folder readme.   
3. Tech \- all google docs etc. into pdfs.   
   1. Check Technology HW slides  
   2. Create separate subfolders for each HW subject and follow class numbering  
   3. Last set of HW files, exam files etc. to pdfs \- ensure latest versions  
   4. Make recording be pausable.   
   5. Convert preschool google docs to other formats  
4. Summer Break \- daily practice 1hr \- maths, programming, music \- new homeworks diary for summer  \- also update what you practiced in the diary \- which math problems etc.   
5. **Teacher/Parent Homework (HW):**  
...
* Sorting algorithms  
* Roman numerals  
* [https://medium.com/data-science/understanding-llms-from-scratch-using-middle-school-math-e602d27ec876](https://medium.com/data-science/understanding-llms-from-scratch-using-middle-school-math-e602d27ec876)   
* Projects for teacher: mario maths game, brain vita game.   
* Open source Chess game trainer  
...
* Kannada dictionary: [https://dsal.uchicago.edu/dictionaries/kittel/](https://dsal.uchicago.edu/dictionaries/kittel/)   
* [Digital Dictionaries of South Asia](https://dsal.uchicago.edu/dictionaries/) : [https://dsal.uchicago.edu/dictionaries/](https://dsal.uchicago.edu/dictionaries/)  
